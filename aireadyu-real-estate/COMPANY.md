...
**[Get AI Ready U: Real Estate on Gumroad → $69](https://fruverse.gumroad.com/l/aireadyu-real-estate)**
...
After purchase, extract to `~/Documents/AIReadyU-Real-Estate/` and switch each agent from Managed to External in the Paperclip dashboard.

## Install

```bash
npx companies.sh add fru-dev3/companies/aireadyu-real-estate --include company,agents,skills
```
