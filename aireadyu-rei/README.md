...
```bash
npx companies.sh add fru-dev3/companies/aireadyu-rei --include company,agents,projects,tasks
```

This creates 11 agents in Paperclip (10 domain + 1 Portfolio Director) with bootstrap tasks and sample goals. Agent instructions are loaded externally from `~/Documents/AIReadyU-REI/`.
...
~/Documents/AIReadyU-REI/ (paid pack):
...
### Step 3: Extract to `~/Documents/AIReadyU-REI/`
...
|-------|-----------------|
| Chief of Staff | `~/Documents/AIReadyU-REI/agents/chief-of-staff` |
| Properties | `~/Documents/AIReadyU-REI/agents/properties-agent` |
| Acquisitions | `~/Documents/AIReadyU-REI/agents/acquisitions-agent` |
| Tenants | `~/Documents/AIReadyU-REI/agents/tenants-agent` |
| Maintenance | `~/Documents/AIReadyU-REI/agents/maintenance-agent` |
| Financing | `~/Documents/AIReadyU-REI/agents/financing-agent` |
| Taxes | `~/Documents/AIReadyU-REI/agents/taxes-agent` |
| Insurance | `~/Documents/AIReadyU-REI/agents/insurance-agent` |
| Legal | `~/Documents/AIReadyU-REI/agents/legal-agent` |
| Accounting | `~/Documents/AIReadyU-REI/agents/accounting-agent` |
| Market | `~/Documents/AIReadyU-REI/agents/market-agent` |

### Step 5: Drop your documents

Replace the synthetic data in `~/Documents/AIReadyU-REI/vault/` with your real files.
