...
```bash
npx companies.sh add fru-dev3/companies/aireadyu-smb --include company,agents,projects,tasks
```

This creates 13 agents in Paperclip (12 domain + 1 Chief of Staff) with bootstrap tasks and sample goals. Agent instructions are loaded externally from `~/Documents/AIReadyU-SMB/`.
...
~/Documents/AIReadyU-SMB/ (paid pack):
...
### Step 3: Extract to `~/Documents/AIReadyU-SMB/`

```
~/Documents/AIReadyU-SMB/
...
|-------|-----------------|
| Chief of Staff | `~/Documents/AIReadyU-SMB/agents/chief-of-staff` |
| Operations | `~/Documents/AIReadyU-SMB/agents/operations-agent` |
| Customers | `~/Documents/AIReadyU-SMB/agents/customers-agent` |
| Sales | `~/Documents/AIReadyU-SMB/agents/sales-agent` |
| Marketing | `~/Documents/AIReadyU-SMB/agents/marketing-agent` |
| Finance | `~/Documents/AIReadyU-SMB/agents/finance-agent` |
| HR | `~/Documents/AIReadyU-SMB/agents/hr-agent` |
| Legal | `~/Documents/AIReadyU-SMB/agents/legal-agent` |
| Vendors | `~/Documents/AIReadyU-SMB/agents/vendors-agent` |
| Products | `~/Documents/AIReadyU-SMB/agents/products-agent` |
| Knowledge | `~/Documents/AIReadyU-SMB/agents/knowledge-agent` |
| Tech | `~/Documents/AIReadyU-SMB/agents/tech-agent` |
| Admin | `~/Documents/AIReadyU-SMB/agents/admin-agent` |

### Step 5: Drop your documents

Replace the synthetic data in `~/Documents/AIReadyU-SMB/vault/` with your real files.
